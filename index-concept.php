	...
	<div id="content">
		<div class="menu">
			<div class="menu-header"></div>
				<ul>
					...
					<li><a href="index-findeverything.php">Find concept</a></li>
				</ul>
		...
		<div class="main-wrapper">
			...
			<div class="nav_bar">
				<ul>
					<li><a href="index.php">Find people</a></li>
					<li><a href="index-concept.php" id="onlink">Find concept</a></li>				
				</ul>
			</div>
			<div class="main_container">
				<div class="search-box">
					<h3 style="color: #0C304A">Search by keywords:</h3>
					<div class="keywords">
						...
						<input type="submit" id="keywordSubmit" value="Search" onClick="concept()" style="margin-left: 170px; margin-top: 10px;" />
					</div>
