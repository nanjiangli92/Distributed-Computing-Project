...
<body class="homepage" onLoad="concept_timeline(<?php echo $id ?>)">
	...
	<div id="content">
		...
		<div class="main-wrapper">
			<div class="centre-wrapper">
				...
				<div class="nav_bar">
					<ul>
						<li><a href="concept-list.php?id=<?php echo $id ?>">list</a></li>
						<li><a href="concept-timeline.php?id=<?php echo $id ?>" id="onlink">timeline</a></li>
					</ul>
				</div>
				<div class="main_container">
					<div class="index">
						...
						<p style="text-decoration: underline; margin-left: 10px;">
							<?php echo"{$personal['fst_name']} {$personal['lst_name']}"?>/ all concept/ timeline/
						</p>
