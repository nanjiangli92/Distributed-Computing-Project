...
<?php
	...
	$res_concept1=mysqli_query($conn,$sql_concept);
	...
	<div id="content">
		...
		<div class="main-wrapper">
			<div class="centre-wrapper">
				...
				<div class="nav_bar">
					<ul>
						<li><a href="concept-list.php?id=<?php echo $id ?>" id="onlink">list</a></li>
						<li><a href="concept-timeline.php?id=<?php echo $id ?>">timeline</a></li>
					</ul>
				</div>
				<div class="main_container">
					<div class="index">
						...
						<p style="text-decoration: underline; margin-left: 10px;">
							<?php echo"{$personal['fst_name']} {$personal['lst_name']}"?>/ all concept/ list/
						</p>
					...
					<div class="concept-list" style="width: 99%; margin-left: 0.5%; margin-top: 10px; border: 1px solid #B6B6B6;" ">
							<?php 
								$index=0;
								while($concept1=mysqli_fetch_assoc($res_concept1)){
							?>
									<p style="margin-left: 10px;">
										<?php 
											echo "<a href='concept-detail.php?id={$id}&concept={$concept1['field']}'>◈ {$concept1['field']}</a>";
										?>
									</p>
							<?php 
								}
