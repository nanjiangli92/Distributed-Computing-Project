...
<?php
	...
	$res_similar_author1=mysqli_query($conn,$sql_similar_author);
				...
				<div class="main_container">
					<div class="index">
						...
						<p style="text-decoration: underline; margin-left: 10px;">
							<?php echo"{$personal['fst_name']} {$personal['lst_name']}"?>/ all similar authors/
						</p>
					...
					<div class="similar-author" style="width: 99%; margin-left: 0.5%; margin-top: 10px; border: 1px solid #B6B6B6;" >
						<?php 
							while($similar_list=mysqli_fetch_assoc($res_similar_author1)){
						?>
								<p style="margin-left: 10px;">
									<?php echo"<a href='personal-main.php?id={$similar_list['id']}'>◈ {$similar_list['fst_name']} {$similar_list['lst_name']}</a>" ?>
								</p>
						<?php
							}
						?>
