...
<body class="homepage" onLoad="co_timeline(<?php echo $id ?>)">
			...
			<div class="centre-wrapper">
				...
				<div class="nav_bar">
					<ul>
						...
						<li><a href="co-timeline.php?id=<?php echo $id ?>" id="onlink">timeline</a></li>
				...
				<div class="main_container">
					<div class="index">
						...
						<p style="text-decoration: underline; margin-left: 10px;">
							<?php echo"{$personal['fst_name']} {$personal['lst_name']}"?>/ all co-authors/ timeline/
						</p>
					...
					<div id="co-timeline" style="margin-top: 5px; border: 1px solid #B6B6B6; width: 99%; margin-left: 0.5%;">
